...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://lorven-systems.vercel.app" },
      { property: "og:image", content: "https://lorven-systems.vercel.app/og-image.png" },
      ...
      { name: "twitter:image", content: "https://lorven-systems.vercel.app/og-image.png" },
    ],
    links: [
